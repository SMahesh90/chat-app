...
**Example `application.properties` (uses environment variables with local fallbacks):**
​```properties
spring.datasource.url=jdbc:mysql://${MYSQLHOST:localhost}:${MYSQLPORT:3306}/${MYSQLDATABASE:chatapp}
spring.datasource.username=${MYSQLUSER:your_local_username}
spring.datasource.password=${MYSQLPASSWORD:your_local_password}
...
<img width="1340" height="852" alt="Screenshot 2026-09-04 103410" src="https://github.com/user-attachments/assets/b77510ce-847c-4f6c-8e03-2c13e7cbad16" />
